(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["businessChunk"],{
                    ...
                    [
                      _c("div", { staticClass: "kt-widget14" }, [
                        _c(
                          ...
                          [
                            _c("h3", { staticClass: "kt-widget14__title" }, [
                              _vm._v("Categorías Personalizadas")
                            ]),
                            _vm._v(" "),
                            _c("span", { staticClass: "kt-widget14__desc" }, [
                              _vm._v(
                                "Crea categerías especializadas para tu empresa, tus productos y tus servicios. Esto sirve para ayudar a organizar las ideas de innovación en grupos específicos."
                              )
                            ])
                          ]
                        ),
                        ...
                        _c("div", { staticClass: "kt-widget14__chart" }, [
                          _c("img", {
                            staticClass: "ml-3 animateOnHover",
                            attrs: {
                              src: _vm.baseUrl + "img/category.svg",
                              width: "90%",
                              height: "90%",
                              alt: ""
                            }
                    ...
                    [
                      _c("div", { staticClass: "kt-widget14" }, [
                        _c(
                          ...
                          [
                            _c("h3", { staticClass: "kt-widget14__title" }, [
                              _vm._v("Reportes & Gráficas")
                            ]),
                            _vm._v(" "),
                            _c("span", { staticClass: "kt-widget14__desc" }, [
                              _vm._v(
                                "Reportes gráficos de datos basados en ideas y retos."
                              )
                            ])
                          ]
                        ),
                        ...
                        _c("div", { staticClass: "kt-widget14__chart" }, [
                          _c("img", {
                            staticClass: "ml-3 animateOnHover",
                            attrs: {
                              src: _vm.baseUrl + "img/hologram.svg",
                              width: "90%",
                              height: "90%",
                              alt: ""
                            }
