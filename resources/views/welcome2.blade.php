  ...
  <nav class="navbar navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a id="register-header" class="register btn btn-cliengo-register pull-right"
          href="#">
          Comenzar
        </a>
      ...
      <div class="collapse navbar-collapse" id="mobile-navbar">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="#">Blog</a></li>
          <li class="register">
            <a id="register-header" class="register btn" href="">
              Comenzar
            </a>
          </li>
          <li class="login">
...
<body>
        ...
        <div class="col-xs-12 content">
          ...
          <div class="animated" data-animation="fadeIn">
            <p>
              ...
              <br>
              Asakaa <em>Innova</em> permite a usuarios y generadores de ideas recibir retroalimentación, votar y compartir diferentes opiniones sobre futuros proyectos. 
            </p>
            <div class="video-container header" data-embed="HzaL5A6I1yk">
      ...
      <div class="block-container">
        ...
        <div class="block-crm animated" data-animation="slideInRight">
          <div class="block-description">
            ...
            <br>
            <div style="height: 5px;"></div>
            <a href='crm.html'>Descubre administración centralizada</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="companyTestimonial" class="scroll-animations">
    <div class="container animated" data-animation="fadeIn">
      ...
      <div class="content">
        ...
        <div class="clg-2 video-container" data-embed="IR3vbSpnlOY">
          <div class="play-button"></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-xs-12 content">
            ...
            <div class="animated" data-animation="slideInUp">
              <p>
                Utilizar una herramienta de innovación incrementa considerablemente la madurez y la objetividad de las ideas mientras son convertidas en proyectos reales y
              </p>
            </div>
          </div>
        </div>
  ...
  <section id="live-end white-bg">
    <div class="container register-landing scroll-animations">
      <div class="row animated" data-animation="fadeIn">
        ...
        <div class="col-xs-12 text-center">
        <a href="{{route('login')}}" class="btn btn-lg">Regístrate ahora
            gratis</a>
        </div>
      </div>
    </div>
      ...
      for (var i = 0; i < youtube.length; i++) {
        ...
        youtube[i].addEventListener("click", function () {
          ...
          iframe.setAttribute("src",
            "https://www.youtube.com/embed/" + this.dataset.embed + "?rel=0&showinfo=0&autoplay=1&start=0");
          this.innerHTML = "";
  ...
  <footer>
    ...
    <div id="social-networks" class="links">
      <h5>Síguenos en</h5>
      <div class="social">
        <a href="" target="_blank">
