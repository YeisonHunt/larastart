        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              ...
              <div class="kt-portlet">
										<div class="kt-portlet__head">
											...
											<div class="kt-portlet__head-toolbar">
												<div class="kt-portlet__head-actions">
													...
													<router-link v-bind:to="'/innovationsEdit/'+this.id" class="btn btn-outline-danger btn-sm btn-icon btn-icon-md">
										...
										<div class="kt-portlet__body" id="ideaBody" v-html="idea.body">
                                                                    ...
                                                                    <div class="kt-widget4">
                                                                        <div class="kt-widget4__item">
                                                                            <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                                                <img src="https://microhealth.com/assets/images/illustrations/personal-user-illustration-@2x.png" height="40" width="130" alt="">
                                                                            </div>
...
<script>
    ...
    export default {
        ...
        loadUsers(){
            ...
            axios.get('/getInnovation/'+this.id).then(({data})=>(this.idea=data));
