      ...
      <div class="col-md-6 col-sm-12" style="background-color:#fff">
        ...
        <br>
            ...
            <div class="images "  v-viewer >
                <img :src="imageRandom" class="imgFit">
            </div>
...
export default {
  ...
  methods: {
    ...
    onFilePicked(event) {
      ...
      fileReader.addEventListener("load", () => {
        ...
        this.imageRandom = fileReader.result;
      });
    ...
    createBlog() {
      ...
      axios
        .post("/blog-interno-save", formData, config)
        .then(({ data }) => {
  ...
  mounted() {
    ...
    this.imageRandom = this.host + "/images/" + this.fotos[this.random]
  }
};
</script>
