									...
									<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-widget14">
											<div class="kt-widget14__header">
												...
												<span class="kt-widget14__desc">
													Productivity Share between co-workers
												</span>
											</div>
											<div class="kt-widget14__content">
												...
												<div class="kt-widget14__legends">
													<div class="kt-widget14__legend">
														...
														<span class="kt-widget14__stats">37% Project # 1</span>
													</div>
													<div class="kt-widget14__legend">
														<span class="kt-widget14__bullet kt-bg-warning"></span>
														<span class="kt-widget14__stats">47% Project X</span>
													</div>
													<div class="kt-widget14__legend">
														<span class="kt-widget14__bullet kt-bg-brand"></span>
														<span class="kt-widget14__stats">19% Project Y</span>
													</div>
												</div>
											</div>
										</div>
													...
													<div class="kt-widget2">
														...
														<div class="kt-widget2__item kt-widget2__item--warning">
															...
															<div class="kt-widget2__actions">
																...
																<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right" x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(334px, 11px, 0px);">
																	<ul class="kt-nav">
																		<li class="kt-nav__item">
																			<a href="#" class="kt-nav__link">
																				<i class="kt-nav__link-icon flaticon2-line-chart"></i>
										...
										<div class="kt-portlet__head">
											...
											<div class="kt-portlet__head-toolbar">
												<ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-toggle="tab" href="#kt_widget6_tab1_content" role="tab" aria-selected="true">
															Latest
														</a>
													</li>
													<li class="nav-item">
