    ...
    <div class="hole">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div
            class="col-12"
            style="  overflow: scroll;  background-color:#F7F8FB; box-shadow: 0 5px 5px rgba(0,0,0,0.05), 0 3px 3px rgba(0,0,0,0.05);"
          >
        ...
        <div class="row">
          ...
          <div
            class="col-12"
            style="background-color:#F7F8FB; box-shadow: 0 5px 5px rgba(0,0,0,0.05), 0 3px 3px rgba(0,0,0,0.05);"
          >
            <table class="table table-striped table-hover">
              <thead class="thead-dark">
                <tr>
