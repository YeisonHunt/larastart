                            ...
                            <div class="col-12">
                                <div class="kt-section">
												<span class="kt-section__info">
													Reto Actual : {{reto.title}}
												</span>
												<div class="kt-section__content kt-section__content--solid">
													Descripción corta:  {{reto.description}}
												</div>
											</div>
                            </div>
                        </div>
									...
									<div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile myForm " id="kt_page_portlet">
										...
										<div class="kt-portlet__head kt-portlet__head--lg" style="">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">Centro de soluciones</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<router-link :to="{name:'ver-reto',params:{id:$route.params.id}}" class="btn btn-clean kt-margin-r-10">
										...
										<div class="kt-portlet__body blocked ">
											...
											<center>
												...
												<div class="btn-group">
													<button  class="btn btn-brand" type="submit" :disabled="form.busy">
														<i style="padding-bottom:8px;" class="la la-check"></i>
														<span class="kt-hidden-mobile">Guardar nueva para reto</span>
													</button>
...
export default {
	...
	methods: {
      ...
      this.$Progress.finish();
        ...
        getReto(){
             axios
        .get("/getInnovation/" + this.$route.params.id)
        .then(response => {
          this.reto = response.data.idea;
