<template>
 ...
 <div style="min-height:80vh;">
  ...
  <div class="row" v-if="1==2">
    <div class="col">
      <button class="btn btn-primary float-right mb-2" @click="modalCreateUser">
        Add Idea &nbsp;
                ...
                <div class="kt-portlet__body">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      aria-describedby="emailHelp"
                      placeholder="Enter bug or feature"
                    >
          ...
          <tr v-for="idea in ideas" :key="ideas.id">
            ...
            <td>
              <a href="javascript:void(0);" @click="modalEditUser(idea)">
                <i class="flaticon-settings-1 bigIcons">
                  <span></span>
                </i>
              </a>
              ...
              >
                <i class="flaticon-delete bigIcons">
                  <span></span>
                </i>
              </a>
            </td>
