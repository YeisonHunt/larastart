            ...
            <div class="blog">
              ...
              <div class="mt-5">
                ...
                <v-row>
                  ...
                  <v-icon :color="'#3BCBFF'">account_circle</v-icon> Yeison Caicedo &nbsp;&nbsp;
                  <v-icon :color="'#3BCBFF'">label</v-icon> innovación, empresas, modernización &nbsp;&nbsp;
                </div>
                  </v-col>
...
Ahora que ya sabemos la definición, volvamos a nuestro punto de inicio.
                  ...
                  <h4>¿Por qué es importante la innovación?</h4>
  ...
  describe en su artículo: "Why Innovation Is Crucial To Your Organization's Long-Term Success" (Por qué la Innovación es crucial para el éxito a largo plazo en su organización) qué la innovación es importante por tres puntos claves:
                  ...
                  <ul>
                    <li>Innovación facilita las empresas penetrar en los mercados y abrir nuevos mercados más rápido, especialmente así en países más ricos.</li>
                    <br>
                    <li>Innovación también ayuda desarrollar y mejorar conceptos originales, ayudando a los innovadores tener una actitud proactiva y tener confianza en tomar riesgos y terminar las cosas tomando decisiones.</li>
                    <br>
                    <li>Cuando la empresa tiene una cultura innovativa, crecerá más fácilmente, aunque el proceso creativo no siempre es sencillo. Métodos para gestionar la innovación probadas y confirmadas pueden ser de mucha ayuda, pero probar nuevas cosas puede muchas veces merece la pena.</li>
                  </ul>

                  <br />
                  <br />Adicionalment, Booz & Co. (ahora Strategy&)
                  <a
                    href="https://www.businessinsider.com/booz-and-cos-innovation-study-2011-10"
                  >2011 Global Innovation 1000 report</a>
 ha descubierto una diferencia tanto en el crecimiento de los ingresos anuales (+11%) Como en EBITDA (+22%) en favor de las organizaciones más innovadoras.
                  <br />
...
En empresas pequeñas este proceso de "búsqueda de mejora continua" está muchas veces construido sobre la personalidad del fundador o dueño de la empresa, pero en cuanto la empresa crece la cosa cambia.
                  ...
                  <v-img
                    ...
                    contain
                    :src="'https://startse.azureedge.net/api/portal/2018/12/Google.jpg'"
                    alt="Google enterprise"
                  ></v-img>
              ...
              <div class="mt-10 mb-10">
                <div class="text-left">
                  <v-btn :to="{name:'blog'}" rounded dark color="grey">
                    <v-icon>arrow_left</v-icon>Lista de blogs
                  </v-btn>
                </div>
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      url: "https://guardproject.com/blog/por-que-la-innovacion-es-importante-para-las-empresas"
    }
  },
  mounted() {
